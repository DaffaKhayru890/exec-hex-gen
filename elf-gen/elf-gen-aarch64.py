...
def gen_elf_header(
	entry_point, phoff, ehsize=64, phentsize=56, phnum=1,
	shoff=0, shentsize=0, shnum=0, shstrndx=0, e_type=2,
	e_machine=0
):
	e_ident = bytearray(b'\x7fELF' + bytes([2,1,1,0,0]) + bytes(7))
...
if __name__ == '__main__':
	...
	program_header=gen_prog_header(
		p_type=1, p_flags=1, p_offset=0, p_vaddr=0x400000,
		p_paddr=0x400000, p_filesz=0x80, p_memsz=0x80, p_align=0x10000
	)
